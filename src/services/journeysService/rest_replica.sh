...
pkill -f "mongod.*port 27017" || echo "⚠️ Port 27017 not running"
pkill -f "mongod.*port 27018" || echo "⚠️ Port 27018 not running"
pkill -f "mongod.*port 27019" || echo "⚠️ Port 27019 not running"
