    ...
    const onClickUpdate = (e) => {
        ...
        .then(response => {
            if (response.data.success) {
                ...
                // Optionally, you can update local state or trigger any other side effects
            } else {
    ...
    return (
        <div className="card-wrapper">
            <div className="checkbox-wrapper">
                <input className="inp-cbx" id={`cbx-${checkboxIndex}`} type="checkbox" checked={input.done} onChange={onClickUpdate}/>
